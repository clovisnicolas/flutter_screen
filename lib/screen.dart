...
class Screen {
  static const MethodChannel _channel = MethodChannel('github.com/anil-shrestha/flutter_screen');
  ...
  static Future keepOn(bool? on) => _channel.invokeMethod('keepOn', {"on": on ?? false});
}
